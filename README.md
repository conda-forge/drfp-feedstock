...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/drfp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13392&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/drfp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `drfp` can be installed with:

```
conda install drfp
```

It is possible to list all of the versions of `drfp` available on your platform with:
